...
const sep = 120.0;
pw.TextStyle bold = pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 10);
pw.TextStyle light = const pw.TextStyle(fontSize: 10);
Future<Uint8List> rekap(
    PdfPageFormat format,
    List<RekapModel> as,
    double tahunTotalOngkos,
    double tahunTotalKeluar,
    double tahunTotalSisa,
    double tahunTotalPerbaikan,
    double tahunTotalBersih) async {
                ...
                child: pw.Container(
                    ...
                    child: pw.Row(
                      ...
                      children: [
                        ...
                        pw.Text(Rupiah.format2(element.totalOngkos),
                            style: small),
                      ],
                    ))),
            pw.Expanded(
                ...
                child: pw.Container(
                    ...
                    child: pw.Row(
                      ...
                      children: [
                        pw.Text("Rp.",style: small),
                        pw.Text(Rupiah.format2(element.totalKeluar),
                            style: small),
                      ],
                    ))),
            pw.Expanded(
                ...
                child: pw.Container(
                    ...
                    child: pw.Row(
                      ...
                      children: [
                        pw.Text("Rp.",style: small),
                        pw.Text(Rupiah.format2(element.totalSisa),
                            style: small),
                      ],
                    ))),
            pw.Expanded(
                ...
                child: pw.Container(
                    ...
                    child: pw.Row(
                      ...
                      children: [
                        pw.Text("Rp.",style: small),
                        pw.Text(Rupiah.format2(element.totalPerbaikan),
                            style: small),
                      ],
                    ))),
            pw.Expanded(
                ...
                child: pw.Container(
                    ...
                    child: pw.Row(
                      ...
                      children: [
                        pw.Text("Rp.",style: small),
                        pw.Text(Rupiah.format2(element.totalBersih),
                            style: small),
                      ],
                    ))),
          ],
